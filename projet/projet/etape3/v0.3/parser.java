...
/** CUP v0.10k TUM Edition 20050516 generated parser.
  * @version Tue Dec 06 10:32:51 CET 2016
  */
...
class CUP$parser$actions {
    ...
    class ProgramData {
        private ArrayList<String> identAppareil;
        private ArrayList<String> identInterface;
        ...
        public ProgramData() {
            this.identAppareil          = new ArrayList<String>();
            this.identInterface         = new ArrayList<String>();
        ...
        public void addIdentAppareil(String ident)      { this.identAppareil.add(ident); }
        public void addIdentInterface(String ident)     { this.identInterface.add(ident); }
        ...
        public boolean hasIdentAppareil(String ident)       { return this.identAppareil.contains(ident); }
        public boolean hasIdentInterface(String ident)      { return this.identInterface.contains(ident); }
    ...
    public void addIdentAppareil(ArrayList<String> l) {
        Iterator<String> itr = l.iterator();
        while(itr.hasNext()) {
            String ident = itr.next();
            if(!data.hasIdentAppareil(ident))
                data.addIdentAppareil(ident);
            else
    ...
    public void addIdentInterface(ArrayList<String> l) {
        Iterator<String> itr = l.iterator();
        while(itr.hasNext()) {
            String ident = itr.next();
            if(!data.hasIdentInterface(ident))
                data.addIdentInterface(ident);
            else
 ...
 System.out.println("\tDéclaration des commandes..."); 
        ...
        if(!data.hasIdentAppareil(id) && !data.hasTemporalyIdent(id))
