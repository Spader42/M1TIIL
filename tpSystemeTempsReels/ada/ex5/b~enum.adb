pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~enum.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~enum.adb");
...
package body ada_main is
   ...
   is
      ...
      pragma Import (Ada, Ada_Main_Program, "_ada_enum");
