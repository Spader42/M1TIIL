...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_section_critique" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ab5bbeee#;
   pragma Export (C, u00001, "section_critiqueB");
   ...
   u00044 : constant Version_32 := 16#84ad4a42#;
   pragma Export (C, u00044, "ada__numericsS");
   u00045 : constant Version_32 := 16#00dc945f#;
   pragma Export (C, u00045, "ada__real_timeB");
   u00046 : constant Version_32 := 16#5bfb6637#;
   pragma Export (C, u00046, "ada__real_timeS");
   u00047 : constant Version_32 := 16#763c483e#;
   pragma Export (C, u00047, "system__arith_64B");
   u00048 : constant Version_32 := 16#748dd1fb#;
   pragma Export (C, u00048, "system__arith_64S");
   u00049 : constant Version_32 := 16#a6fc8110#;
   pragma Export (C, u00049, "system__taskingB");
   u00050 : constant Version_32 := 16#61a61d3d#;
   pragma Export (C, u00050, "system__taskingS");
   u00051 : constant Version_32 := 16#e28875aa#;
   pragma Export (C, u00051, "system__task_primitivesS");
   u00052 : constant Version_32 := 16#c9494811#;
   pragma Export (C, u00052, "system__os_interfaceB");
   u00053 : constant Version_32 := 16#732a7471#;
   pragma Export (C, u00053, "system__os_interfaceS");
   u00054 : constant Version_32 := 16#a2230cb9#;
   pragma Export (C, u00054, "interfaces__cB");
   u00055 : constant Version_32 := 16#ebbc3ca7#;
   pragma Export (C, u00055, "interfaces__cS");
   u00056 : constant Version_32 := 16#6470edba#;
   pragma Export (C, u00056, "system__linuxS");
   u00057 : constant Version_32 := 16#52a12383#;
   pragma Export (C, u00057, "system__task_primitives__operationsB");
   u00058 : constant Version_32 := 16#e8297115#;
   pragma Export (C, u00058, "system__task_primitives__operationsS");
   u00059 : constant Version_32 := 16#b71e6964#;
   pragma Export (C, u00059, "system__bit_opsB");
   u00060 : constant Version_32 := 16#c30e4013#;
   pragma Export (C, u00060, "system__bit_opsS");
   u00061 : constant Version_32 := 16#2a8bb2a4#;
   pragma Export (C, u00061, "system__interrupt_managementB");
   u00062 : constant Version_32 := 16#8aeaffc0#;
   pragma Export (C, u00062, "system__interrupt_managementS");
   u00063 : constant Version_32 := 16#17ae9ccc#;
   pragma Export (C, u00063, "system__multiprocessorsB");
   u00064 : constant Version_32 := 16#1b4d6878#;
   pragma Export (C, u00064, "system__multiprocessorsS");
   u00065 : constant Version_32 := 16#22d03640#;
   pragma Export (C, u00065, "system__os_primitivesB");
   u00066 : constant Version_32 := 16#93307b22#;
   pragma Export (C, u00066, "system__os_primitivesS");
   u00067 : constant Version_32 := 16#cf99f883#;
   pragma Export (C, u00067, "system__stack_checking__operationsB");
   u00068 : constant Version_32 := 16#49df1cef#;
   pragma Export (C, u00068, "system__stack_checking__operationsS");
   u00069 : constant Version_32 := 16#13cbc5a8#;
   pragma Export (C, u00069, "system__crtlS");
   u00070 : constant Version_32 := 16#3d54d5f6#;
   pragma Export (C, u00070, "system__task_infoB");
   u00071 : constant Version_32 := 16#6cfdb051#;
   pragma Export (C, u00071, "system__task_infoS");
   u00072 : constant Version_32 := 16#0a363cc0#;
   pragma Export (C, u00072, "system__tasking__debugB");
   u00073 : constant Version_32 := 16#71f06032#;
   pragma Export (C, u00073, "system__tasking__debugS");
   u00074 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00074, "system__concat_2B");
   u00075 : constant Version_32 := 16#d83105f7#;
   pragma Export (C, u00075, "system__concat_2S");
   u00076 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00076, "system__concat_3B");
   u00077 : constant Version_32 := 16#55cbf561#;
   pragma Export (C, u00077, "system__concat_3S");
   u00078 : constant Version_32 := 16#c9fdc962#;
   pragma Export (C, u00078, "system__concat_6B");
   u00079 : constant Version_32 := 16#e42b021f#;
   pragma Export (C, u00079, "system__concat_6S");
   u00080 : constant Version_32 := 16#def1dd00#;
   pragma Export (C, u00080, "system__concat_5B");
   u00081 : constant Version_32 := 16#33d839aa#;
   pragma Export (C, u00081, "system__concat_5S");
   u00082 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00082, "system__concat_4B");
   u00083 : constant Version_32 := 16#21be14b5#;
   ...
   u00085 : constant Version_32 := 16#a4e63cfb#;
   ...
   u00104 : constant Version_32 := 16#1358602f#;
   pragma Export (C, u00104, "ada__streamsS");
   u00105 : constant Version_32 := 16#7a48d8b1#;
   pragma Export (C, u00105, "interfaces__c_streamsB");
   u00106 : constant Version_32 := 16#40dd1af2#;
   pragma Export (C, u00106, "interfaces__c_streamsS");
   u00107 : constant Version_32 := 16#5efa797c#;
   pragma Export (C, u00107, "system__file_ioB");
   u00108 : constant Version_32 := 16#2e96f0e6#;
   pragma Export (C, u00108, "system__file_ioS");
   u00109 : constant Version_32 := 16#7cc77cc0#;
   pragma Export (C, u00109, "ada__finalizationB");
   u00110 : constant Version_32 := 16#01acb175#;
   pragma Export (C, u00110, "ada__finalizationS");
   u00111 : constant Version_32 := 16#01cb6d81#;
   pragma Export (C, u00111, "system__finalization_rootB");
   u00112 : constant Version_32 := 16#2d16f6f3#;
   pragma Export (C, u00112, "system__finalization_rootS");
   u00113 : constant Version_32 := 16#dbb36d26#;
   pragma Export (C, u00113, "system__finalization_implementationB");
   u00114 : constant Version_32 := 16#bdfa5ab4#;
   pragma Export (C, u00114, "system__finalization_implementationS");
   u00115 : constant Version_32 := 16#386436bc#;
   pragma Export (C, u00115, "system__restrictionsB");
   u00116 : constant Version_32 := 16#db039e46#;
   pragma Export (C, u00116, "system__restrictionsS");
   u00117 : constant Version_32 := 16#a6e358bc#;
   pragma Export (C, u00117, "system__stream_attributesB");
   u00118 : constant Version_32 := 16#e89b4b3f#;
   ...
   u00120 : constant Version_32 := 16#7401caa7#;
   pragma Export (C, u00120, "interfaces__c__stringsB");
   u00121 : constant Version_32 := 16#739e0600#;
   pragma Export (C, u00121, "interfaces__c__stringsS");
   u00122 : constant Version_32 := 16#621b06ef#;
   pragma Export (C, u00122, "system__crtl__runtimeS");
   u00123 : constant Version_32 := 16#f74220e8#;
   pragma Export (C, u00123, "system__os_libB");
   u00124 : constant Version_32 := 16#a6d80a38#;
   pragma Export (C, u00124, "system__os_libS");
   u00125 : constant Version_32 := 16#4cd8aca0#;
   pragma Export (C, u00125, "system__stringsB");
   u00126 : constant Version_32 := 16#940bbdcf#;
   pragma Export (C, u00126, "system__stringsS");
   u00127 : constant Version_32 := 16#fcde1931#;
   pragma Export (C, u00127, "system__file_control_blockS");
   u00128 : constant Version_32 := 16#b90c86f6#;
   pragma Export (C, u00128, "ada__finalization__list_controllerB");
   u00129 : constant Version_32 := 16#b97dfd74#;
   pragma Export (C, u00129, "ada__finalization__list_controllerS");
   u00130 : constant Version_32 := 16#f6fdca1c#;
   pragma Export (C, u00130, "ada__text_io__integer_auxB");
   u00131 : constant Version_32 := 16#b9793d30#;
   pragma Export (C, u00131, "ada__text_io__integer_auxS");
   u00132 : constant Version_32 := 16#515dc0e3#;
   pragma Export (C, u00132, "ada__text_io__generic_auxB");
   u00133 : constant Version_32 := 16#a6c327d3#;
   pragma Export (C, u00133, "ada__text_io__generic_auxS");
   u00134 : constant Version_32 := 16#ef6c8032#;
   pragma Export (C, u00134, "system__img_biuB");
   u00135 : constant Version_32 := 16#8f222330#;
   pragma Export (C, u00135, "system__img_biuS");
   u00136 : constant Version_32 := 16#10618bf9#;
   pragma Export (C, u00136, "system__img_llbB");
   u00137 : constant Version_32 := 16#cee533ce#;
   ...
   u00148 : constant Version_32 := 16#b9035097#;
   pragma Export (C, u00148, "semaphoresB");
   u00149 : constant Version_32 := 16#01589f1c#;
   pragma Export (C, u00149, "semaphoresS");
   u00150 : constant Version_32 := 16#48087e79#;
   pragma Export (C, u00150, "system__tasking__protected_objectsB");
   u00151 : constant Version_32 := 16#e2c8a7eb#;
   pragma Export (C, u00151, "system__tasking__protected_objectsS");
   u00152 : constant Version_32 := 16#ff133197#;
   pragma Export (C, u00152, "system__soft_links__taskingB");
   u00153 : constant Version_32 := 16#da1c0a98#;
   ...
   u00155 : constant Version_32 := 16#c4bf5e73#;
   ...
   u00177 : constant Version_32 := 16#820d6a31#;
   pragma Export (C, u00177, "system__address_imageS");
   u00178 : constant Version_32 := 16#7dbbd31d#;
   pragma Export (C, u00178, "text_ioS");
   u00179 : constant Version_32 := 16#0936cab5#;
   pragma Export (C, u00179, "system__memoryB");
   u00180 : constant Version_32 := 16#e96a4b1e#;
