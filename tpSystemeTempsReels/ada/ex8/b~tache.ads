...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tache" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#2e1a58ef#;
   pragma Export (C, u00001, "tacheB");
   ...
   u00075 : constant Version_32 := 16#3d54d5f6#;
   pragma Export (C, u00075, "system__task_infoB");
   u00076 : constant Version_32 := 16#6cfdb051#;
   pragma Export (C, u00076, "system__task_infoS");
   u00077 : constant Version_32 := 16#0a363cc0#;
   pragma Export (C, u00077, "system__tasking__debugB");
   u00078 : constant Version_32 := 16#71f06032#;
   pragma Export (C, u00078, "system__tasking__debugS");
   u00079 : constant Version_32 := 16#39591e91#;
   pragma Export (C, u00079, "system__concat_2B");
   u00080 : constant Version_32 := 16#d83105f7#;
   pragma Export (C, u00080, "system__concat_2S");
   u00081 : constant Version_32 := 16#ae97ef6c#;
   pragma Export (C, u00081, "system__concat_3B");
   u00082 : constant Version_32 := 16#55cbf561#;
   pragma Export (C, u00082, "system__concat_3S");
   u00083 : constant Version_32 := 16#c9fdc962#;
   pragma Export (C, u00083, "system__concat_6B");
   u00084 : constant Version_32 := 16#e42b021f#;
   pragma Export (C, u00084, "system__concat_6S");
   u00085 : constant Version_32 := 16#def1dd00#;
   pragma Export (C, u00085, "system__concat_5B");
   u00086 : constant Version_32 := 16#33d839aa#;
   pragma Export (C, u00086, "system__concat_5S");
   u00087 : constant Version_32 := 16#3493e6c0#;
   pragma Export (C, u00087, "system__concat_4B");
   u00088 : constant Version_32 := 16#21be14b5#;
   pragma Export (C, u00088, "system__concat_4S");
   u00089 : constant Version_32 := 16#1eab0e09#;
   pragma Export (C, u00089, "system__img_enum_newB");
   u00090 : constant Version_32 := 16#a4e63cfb#;
   ...
   u00092 : constant Version_32 := 16#32aea2da#;
   pragma Export (C, u00092, "system__img_lliS");
   u00093 : constant Version_32 := 16#06417083#;
   pragma Export (C, u00093, "system__img_lluB");
   u00094 : constant Version_32 := 16#00c9abbe#;
   pragma Export (C, u00094, "system__img_lluS");
   u00095 : constant Version_32 := 16#3b607801#;
   pragma Export (C, u00095, "system__stack_usageB");
   u00096 : constant Version_32 := 16#abdf2d5b#;
   pragma Export (C, u00096, "system__stack_usageS");
   u00097 : constant Version_32 := 16#d7aac20c#;
   pragma Export (C, u00097, "system__ioB");
   u00098 : constant Version_32 := 16#bda30044#;
   pragma Export (C, u00098, "system__ioS");
   u00099 : constant Version_32 := 16#07116dec#;
   pragma Export (C, u00099, "ada__tagsB");
   u00100 : constant Version_32 := 16#21b957c3#;
   pragma Export (C, u00100, "ada__tagsS");
   u00101 : constant Version_32 := 16#68f8d5f8#;
   pragma Export (C, u00101, "system__val_lluB");
   u00102 : constant Version_32 := 16#33f2fc0f#;
   pragma Export (C, u00102, "system__val_lluS");
   u00103 : constant Version_32 := 16#46a1f7a9#;
   pragma Export (C, u00103, "system__val_utilB");
   u00104 : constant Version_32 := 16#284c6214#;
   pragma Export (C, u00104, "system__val_utilS");
   u00105 : constant Version_32 := 16#b7fa72e7#;
   pragma Export (C, u00105, "system__case_utilB");
   u00106 : constant Version_32 := 16#8efd9783#;
   pragma Export (C, u00106, "system__case_utilS");
   u00107 : constant Version_32 := 16#7a8f4ce5#;
   pragma Export (C, u00107, "ada__text_ioB");
   u00108 : constant Version_32 := 16#78993766#;
   pragma Export (C, u00108, "ada__text_ioS");
   u00109 : constant Version_32 := 16#1358602f#;
   pragma Export (C, u00109, "ada__streamsS");
   u00110 : constant Version_32 := 16#7a48d8b1#;
   pragma Export (C, u00110, "interfaces__c_streamsB");
   u00111 : constant Version_32 := 16#40dd1af2#;
   pragma Export (C, u00111, "interfaces__c_streamsS");
   u00112 : constant Version_32 := 16#5efa797c#;
   pragma Export (C, u00112, "system__file_ioB");
   u00113 : constant Version_32 := 16#2e96f0e6#;
   pragma Export (C, u00113, "system__file_ioS");
   u00114 : constant Version_32 := 16#7cc77cc0#;
   pragma Export (C, u00114, "ada__finalizationB");
   u00115 : constant Version_32 := 16#01acb175#;
   pragma Export (C, u00115, "ada__finalizationS");
   u00116 : constant Version_32 := 16#01cb6d81#;
   pragma Export (C, u00116, "system__finalization_rootB");
   u00117 : constant Version_32 := 16#2d16f6f3#;
   pragma Export (C, u00117, "system__finalization_rootS");
   u00118 : constant Version_32 := 16#dbb36d26#;
   pragma Export (C, u00118, "system__finalization_implementationB");
   u00119 : constant Version_32 := 16#bdfa5ab4#;
   pragma Export (C, u00119, "system__finalization_implementationS");
   u00120 : constant Version_32 := 16#386436bc#;
   pragma Export (C, u00120, "system__restrictionsB");
   u00121 : constant Version_32 := 16#db039e46#;
   ...
   u00125 : constant Version_32 := 16#7401caa7#;
   pragma Export (C, u00125, "interfaces__c__stringsB");
   u00126 : constant Version_32 := 16#739e0600#;
   pragma Export (C, u00126, "interfaces__c__stringsS");
   u00127 : constant Version_32 := 16#621b06ef#;
   pragma Export (C, u00127, "system__crtl__runtimeS");
   u00128 : constant Version_32 := 16#f74220e8#;
   ...
   u00133 : constant Version_32 := 16#b90c86f6#;
   pragma Export (C, u00133, "ada__finalization__list_controllerB");
   u00134 : constant Version_32 := 16#b97dfd74#;
   pragma Export (C, u00134, "ada__finalization__list_controllerS");
   ...
   u00143 : constant Version_32 := 16#f931f062#;
   pragma Export (C, u00143, "system__img_llwB");
   u00144 : constant Version_32 := 16#67891058#;
   pragma Export (C, u00144, "system__img_llwS");
   u00145 : constant Version_32 := 16#b532ff4e#;
   pragma Export (C, u00145, "system__img_wiuB");
   u00146 : constant Version_32 := 16#e163a4a2#;
   pragma Export (C, u00146, "system__img_wiuS");
   u00147 : constant Version_32 := 16#7993dbbd#;
   pragma Export (C, u00147, "system__val_intB");
   u00148 : constant Version_32 := 16#6b44dd34#;
   pragma Export (C, u00148, "system__val_intS");
   u00149 : constant Version_32 := 16#e6965fe6#;
   pragma Export (C, u00149, "system__val_unsB");
   u00150 : constant Version_32 := 16#59a84646#;
   pragma Export (C, u00150, "system__val_unsS");
   u00151 : constant Version_32 := 16#936e9286#;
   pragma Export (C, u00151, "system__val_lliB");
   u00152 : constant Version_32 := 16#b9c511ab#;
   pragma Export (C, u00152, "system__val_lliS");
   u00153 : constant Version_32 := 16#959cf892#;
   pragma Export (C, u00153, "system__tasking__rendezvousB");
   u00154 : constant Version_32 := 16#d056c48f#;
   pragma Export (C, u00154, "system__tasking__rendezvousS");
   u00155 : constant Version_32 := 16#b59e6e78#;
   pragma Export (C, u00155, "system__tasking__entry_callsB");
   u00156 : constant Version_32 := 16#687efea4#;
   pragma Export (C, u00156, "system__tasking__entry_callsS");
   u00157 : constant Version_32 := 16#4d3e0469#;
   pragma Export (C, u00157, "system__tasking__initializationB");
   u00158 : constant Version_32 := 16#7f6b69f1#;
   pragma Export (C, u00158, "system__tasking__initializationS");
   u00159 : constant Version_32 := 16#ff133197#;
   pragma Export (C, u00159, "system__soft_links__taskingB");
   u00160 : constant Version_32 := 16#da1c0a98#;
   ...
   u00174 : constant Version_32 := 16#becc801d#;
   pragma Export (C, u00174, "system__traces__taskingS");
   u00175 : constant Version_32 := 16#14757b6f#;
   pragma Export (C, u00175, "system__tasking__stagesB");
   u00176 : constant Version_32 := 16#84f88b56#;
   ...
   u00178 : constant Version_32 := 16#820d6a31#;
   pragma Export (C, u00178, "system__address_imageS");
   u00179 : constant Version_32 := 16#7dbbd31d#;
   pragma Export (C, u00179, "text_ioS");
   u00180 : constant Version_32 := 16#0936cab5#;
   pragma Export (C, u00180, "system__memoryB");
   u00181 : constant Version_32 := 16#e96a4b1e#;
