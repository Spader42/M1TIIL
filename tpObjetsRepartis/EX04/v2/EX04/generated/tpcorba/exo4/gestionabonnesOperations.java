...
public interface gestionabonnesOperations
{
	/* constants */
	/* operations  */
	tpcorba.exo4.abonne[] liste_abonnes();
	void creation_abonne(int numero, java.lang.String nom, java.lang.String prenom, tpcorba.exo4.type_adresse adresse, tpcorba.exo4.type_abonnement abonnement, tpcorba.exo4.abonneHolder ref) throws tpcorba.exo4.dejaExistant;
