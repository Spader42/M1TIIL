	...
	implements org.omg.CORBA.portable.InvokeHandler, tpcorba.exo3.compteOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "_get_afficher", new java.lang.Integer(4));
		m_opsHash.put ( "_get_titulaire", new java.lang.Integer(5));
		m_opsHash.put ( "crediter", new java.lang.Integer(6));
		m_opsHash.put ( "nombre_operations", new java.lang.Integer(7));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 4: // _get_afficher
			{
			_out = handler.createReply();
			_out.write_string(afficher());
				break;
			}
