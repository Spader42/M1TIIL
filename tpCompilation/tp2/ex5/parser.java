...
/** CUP v0.10k TUM Edition 20050516 generated parser.
  * @version Fri Oct 07 17:41:19 CEST 2016
  */
public class parser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\002\007\002\000\002\004\005\000\002\004\003\000\002" +
    "\010\002\000\002\004\005\000\002\004\003\000\002\011" +
    "\002\000\002\004\005\000\002\004\003" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\023\000\016\002\uffff\004\005\005\007\006\012\007" +
    "\006\010\011\001\002\000\004\002\001\001\002\000\016" +
    "\002\ufffc\004\ufffe\005\ufffe\006\ufffe\007\ufffe\010\ufffe\001" +
    "\002\000\016\002\ufff9\004\ufffb\005\ufffb\006\ufffb\007\ufffb" +
    "\010\ufffb\001\002\000\016\002\ufff0\004\ufff2\005\ufff2\006" +
    "\ufff2\007\ufff2\010\ufff2\001\002\000\004\002\017\001\002" +
    "\000\016\002\ufff6\004\ufff8\005\ufff8\006\ufff8\007\ufff8\010" +
    "\ufff8\001\002\000\016\002\ufff3\004\ufff5\005\ufff5\006\ufff5" +
    "\007\ufff5\010\ufff5\001\002\000\014\004\005\005\007\006" +
    "\012\007\006\010\011\001\002\000\004\002\ufff4\001\002" +
    "\000\014\004\005\005\007\006\012\007\006\010\011\001" +
    "\002\000\004\002\ufff7\001\002\000\004\002\000\001\002" +
    "\000\014\004\005\005\007\006\012\007\006\010\011\001" +
    "\002\000\004\002\ufff1\001\002\000\014\004\005\005\007" +
    "\006\012\007\006\010\011\001\002\000\004\002\ufffa\001" +
    "\002\000\014\004\005\005\007\006\012\007\006\010\011" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\023\000\006\003\007\004\003\001\001\000\002\001" +
    "\001\000\004\005\023\001\001\000\004\006\021\001\001" +
    "\000\004\011\017\001\001\000\002\001\001\000\004\007" +
    "\014\001\001\000\004\010\012\001\001\000\004\004\013" +
    ...
    "\001\000\004\004\024\001\001\000\002\001\001" });
...
class CUP$parser$actions {
      ...
      switch (CUP$parser$act_num)
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 error += n;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 16: // list_nb ::= WHATEVER NT$4 list_nb 
            {
              Object RESULT = null;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
 error += n;
              CUP$parser$result = new java_cup.runtime.Symbol(7/*NT$4*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 14: // list_nb ::= NEWLINE 
            {
              Object RESULT = null;
		int nleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left;
		int nright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right;
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 str += n;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 13: // list_nb ::= NEWLINE NT$3 list_nb 
            {
              Object RESULT = null;
		...
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
 str += n;
              CUP$parser$result = new java_cup.runtime.Symbol(6/*NT$3*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // list_nb ::= PARG 
            {
              Object RESULT = null;
		int nleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left;
		int nright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right;
		Integer n = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 nbPar++; str += "(";
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 10: // list_nb ::= PARG NT$2 list_nb 
            {
              Object RESULT = null;
		...
		Integer n = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
 nbPar++; str += "(";
              CUP$parser$result = new java_cup.runtime.Symbol(5/*NT$2*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;
		...
		Integer n = (Integer)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 if(nbPar == 0){
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // list_nb ::= PARD NT$1 list_nb 
            {
              Object RESULT = null;
 ...
 if(nbPar == 0){
              ...
              CUP$parser$result = new java_cup.runtime.Symbol(4/*NT$1*/, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right, RESULT);
            }
          return CUP$parser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // list_nb ::= STRING 
            {
              Object RESULT = null;
		int nleft = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).left;
		int nright = ((java_cup.runtime.Symbol)CUP$parser$stack.elementAt(CUP$parser$top-0)).right;
		String n = (String)((java_cup.runtime.Symbol) CUP$parser$stack.elementAt(CUP$parser$top-0)).value;
		 str += n; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // list_nb ::= STRING NT$0 list_nb 
            {
              Object RESULT = null;
